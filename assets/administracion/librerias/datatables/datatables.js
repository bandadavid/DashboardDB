 ...
 *   https://datatables.net/download/#bs/jq-3.6.0/dt-1.11.3/fc-4.0.0/fh-3.2.0/r-2.2.9/rr-1.2.8
 *
 * Included libraries:
 *   jQuery 3 3.6.0, DataTables 1.11.3, FixedColumns 4.0.0, FixedHeader 3.2.0, Responsive 2.2.9, RowReorder 1.2.8
 */
...
(function( $, window, document, undefined ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		var input = '<input type="search" placeholder="Ingrese su búsqueda" class="'+classes.sFilterInput+' mi-input" style="height:30px !important;"/>';
	...
	function _fnFeatureHtmlLength ( settings )
	{
		...
		var select = $('<select class="mi-input"  style="height:30px !important; width:60px !important;"   />', {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sLengthMenu": "<b>Mostrar</b> &nbsp;_MENU_  ",
			 ...
			 *    } );
			 */
			"sLoadingRecords": "Consultando Datos...",
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/jq-3.6.0/dt-1.11.3/fc-4.0.0/fh-3.2.0/r-2.2.9/rr-1.2.8",
				...
				var attach = function( container, buttons ) {
					...
					for ( i=0, ien=buttons.length ; i<ien ; i++ ) {
						...
						if ( Array.isArray( button ) ) {
							...
							if ( btnDisplay !== null ) {
								node = $('<a>', {
										'class': classes.sPageButton+' btn-circle '+btnClass,
...
$.extend( true, DataTable.defaults, {
	dom:
		"<'row'<'col-md-6 text-left'f> <'col-md-6 botonera'>>" +
		"<'row'<'col-md-12'tr>>" +
		"<'row'<'col-md-2'i> <'col-md-8 paginador-dt'p>  <'col-md-2 text-right'l>>",
	renderer: 'bootstrap'
} );
