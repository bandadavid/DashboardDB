...
(function (factory) {
        ...
        _initTemplateDefaults: function () {
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    removeClass: 'btn btn-secundario',
                    removeErrorClass: 'btn btn-secundario',
    ...
    $.fn.fileinput.defaults = {
        ...
        previewZoomButtonIcons: {
            ...
            borderless: '<i class="fa fa-compress-alt"></i>',
        ...
        browseClass: 'btn btn-principal',
        removeIcon: '<i class="fa fa-trash"></i>',
        removeClass: 'btn btn-secundario',
        cancelIcon: '<i class="fa fa-ban-circle"></i>',
        cancelClass: 'btn  btn-secundario',
        pauseIcon: '<i class="fa fa-pause"></i>',
        pauseClass: 'btn  btn-secundario',
        uploadIcon: '<i class="fa fa-upload"></i>',
        uploadClass: 'btn btn-secundario',
        uploadUrl: null,
        uploadUrlThumb: null,
        uploadAsync: true,
        uploadParamNames: {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgInvalidFileExtension: 'Extensión inválida para el archivo "{name}". Únicamente se permiten formatos "{extensions}".',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        dropZoneTitle: 'ARRASTRAR Y SOLTAR ARCHIVOS &hellip;',
